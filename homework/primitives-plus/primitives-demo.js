...
(function () {
    ...
    // lineBresenham lines with dash parameter
    // The first call is to demonstrate that this line will not show up
    Primitives.lineBresenham(renderingContext, 825, 210, 1024, 110, 0);
    Primitives.lineBresenham(renderingContext, 815, 210, 1014, 110, 1);
    Primitives.lineBresenham(renderingContext, 805, 210, 1004, 110, 5);
    Primitives.lineBresenham(renderingContext, 795, 210, 994, 110, 10);
    Primitives.lineBresenham(renderingContext, 785, 210, 984, 110, 20);
    Primitives.lineBresenham(renderingContext, 775, 210, 974, 110, 40);
    Primitives.lineBresenham(renderingContext, 765, 210, 964, 110, 200);
